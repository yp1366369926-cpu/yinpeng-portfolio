...
void main() {
  ...
  gl_FragColor = color;
      ...
      const loop = (time) => {
        if (!rendererRef.current || !uniformsRef.current || !meshRef.current || !pageVisible) return;
      ...
      cleanupFunctionRef.current = () => {
        ...
        try {
          ...
          // The canvas may already be detached during a fast route change.
        }
  ...
  }, [isVisible, speed, rayColor1, rayColor2, intensity, spread, origin, tilt, saturation, blend, falloff, opacity, maxFps]);
